            ...
            <View style={[styles.container, style]}>
                ...
                <Card style={{margin: 0, position: this.state.isImageZoom ? 'absolute' : 'relative'}}>
                    ...
                    <ImageBox pose={this.state.isImageZoom ? 'zoomed' : 'normal'}
                              style={{height: heightPercentageToDP(80), marginTop: -14, padding: 0}}>
                        <ImageZoom
...

                            {
                                typeof question.imageAsset === 'string' ?
                                    <Animated.Image
                                        style={{width: widthPercentageToDP(100), height: this.state.imageHeight}}
                                        source={{uri: question.imageAsset}}
                                        resizeMode='contain'/>
                                    :
                                    <Animated.Image
                                        style={{width: widthPercentageToDP(100), height: this.state.imageHeight}}
